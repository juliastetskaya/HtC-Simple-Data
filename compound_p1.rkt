...
;; Movie Movie -> String
;; Consume two movies and produce the title of the most recently released movie
(check-expect (choose-movie M1 M2) "Avatar")
(check-expect (choose-movie M3 M2) "The Avengers")

;(define (choose-movie m1 m2) "")   ; this is the stub
